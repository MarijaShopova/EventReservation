    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Ticket = c.Boolean(nullable: false),
                        TicketPrice = c.Int(nullable: false),
                        FreeTables = c.Int(nullable: false),
                        BandName = c.String(),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Locals", t => t.Local_Id)
                .Index(t => t.Local_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Events", "LocalId", "dbo.Locals");
            ...
            DropIndex("dbo.Events", new[] { "LocalId" });
